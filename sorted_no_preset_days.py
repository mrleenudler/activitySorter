...
# "Kino i Hall 2" deles i to dager
fordeling = {"Orientering": [], "Frisbee Ultimate": [], "Kino i hall 2 mandag": [], "Kino i hall 2 tirsdag": [], \
...
fordelingMax = {"Orientering": 1000, "Frisbee Ultimate": 1000, "Kino i hall 2 mandag": 1000, "Kino i hall 2 tirsdag": 1000, \
...
fordelingDag = {"Orientering": "tirsdag", "Frisbee Ultimate": "mandag", "Kino i hall 2 mandag": "mandag", "Kino i hall 2 tirsdag": "tirsdag", \
        ...
        for aktivitet1 in tup[inputTupleActivityPosition].split(';'):
            if aktivitet1: # Fixing trailing ';' (perhaps)
                ...
                if aktivitet1 == "Kino i hall 2":
                    ...
                    allApplications.append((tup[inputTupleNamePosition], tup[inputTupleClassPosition], "Kino i hall 2 mandag", highPriorityString, "mandag")) # navn == [9], klassse == [14], aktivitet1 == [17] 
                    aktivitet1 = "Kino i hall 2 tirsdag"
    ...
    for application in list(allApplications):
        if application[applicationTupleNamePosition] == studentName:
            ...
            if fordelingDag[application[applicationTupleActivityPosition]] in eleverMedBekreftedeAktiviteter[studentName]:
                ...
                continue
            allApplications.remove(application)
            # done, men virker den ikke?? VIKTIG - TEST OM DAGEN FOR AKTIVITET ER BOOKET.
            fordeling[application[applicationTupleActivityPosition]].append(studentName) # Adding student to group
...
# Bedre design av spørreskjemaet vil gjøre løsningen redundant.